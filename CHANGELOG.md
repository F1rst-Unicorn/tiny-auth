...
* Scope claims can now go to only some of access token, id token or userinfo
  ([#76](https://veenj.de/git/veenj/tiny-auth/issues/76)).

### Fixed

* Validate token audience for own API
  ([#103](https://veenj.de/git/veenj/tiny-auth/issues/103)).
...
seconds` ([#99](https://veenj.de/git/veenj/tiny-auth/issues/99)).
...
itself ([#48](https://veenj.de/git/veenj/tiny-auth/issues/48)).

The health endpoint checks all LDAPs for
connectivity ([#94](https://veenj.de/git/veenj/tiny-auth/issues/94)).
...
execution ([#86](https://veenj.de/git/veenj/tiny-auth/issues/86)).
...
* Web UI to change passwords
  ([#57](https://veenj.de/git/veenj/tiny-auth/issues/57)).

* Support to run under MacOS
  ([#79](https://veenj.de/git/veenj/tiny-auth/issues/79)).

* Support for [PKCE](https://www.rfc-editor.org/rfc/rfc7636)
  ([#75](https://veenj.de/git/veenj/tiny-auth/issues/75)).

* Support rotation of token signing keys
  ([#55](https://veenj.de/git/veenj/tiny-auth/issues/55)). See documentation
...
* Allow configuration of token timeouts via `web.token timeout in seconds` and
  ...
  ([#78](https://veenj.de/git/veenj/tiny-auth/issues/78)).

### Fixed

* Fix panic when authorising a request with unknown scope
  ([#72](https://veenj.de/git/veenj/tiny-auth/issues/72))
...
* `crypto.key` and `crypto.public key` were replaced in favour of a list of such
  keys
  ([#55](https://veenj.de/git/veenj/tiny-auth/issues/75)).
...
* HTTP health endpoint for monitoring
  ([#59](https://veenj.de/git/veenj/tiny-auth/issues/59))
...
* Send error redirects via URL Fragment for token-containing response types
  ([#68](https://veenj.de/git/veenj/tiny-auth/issues/68))
...
* Support all client authentication methods
  ([#42](https://veenj.de/git/veenj/tiny-auth/issues/42))
...
* Handle invalid refresh tokens with correct error code
  ([#56](https://veenj.de/git/veenj/tiny-auth/issues/56))

* [Rate-limit](doc/configuration.md#rate-limit) the number of failed logins per
  user.
  ([#35](https://veenj.de/git/veenj/tiny-auth/issues/35))
...
* Clients now need a list of allowed scopes, see
  ...
  ([#41](https://veenj.de/git/veenj/tiny-auth/issues/41))
...
* Allow more authentication options for the userinfo endpoint
  ([#50](https://veenj.de/git/veenj/tiny-auth/issues/50))

* Allow authenticated users to return to login for a different account
  ([#47](https://veenj.de/git/veenj/tiny-auth/issues/47))

### Fixed

* Report correct `auth_time` in all tokens
  ([#52](https://veenj.de/git/veenj/tiny-auth/issues/52))
...
* Fix standard scopes. Make sure to align users supporting the `address` scope
  ...
  ([#51](https://veenj.de/git/veenj/tiny-auth/issues/51))
...
* Bind refresh tokens to clients. It was possible for client A to obtain access
  ...
  different client B.
  ([#54](https://veenj.de/git/veenj/tiny-auth/issues/54))
...
* Support for optional parameters in authorization request
  ([#19](https://veenj.de/git/veenj/tiny-auth/issues/19))

### Fixed

* Respect nonce parameter of authorization requests correctly
  ([#46](https://veenj.de/git/veenj/tiny-auth/issues/46))

* Fix missing kid in JWKS
  ([#45](https://veenj.de/git/veenj/tiny-auth/issues/45))
...
* Serve correct JWKS format
  ([#43](https://veenj.de/git/veenj/tiny-auth/issues/43))
...
* Add [scope
  ...
  support ([#10](https://veenj.de/git/veenj/tiny-auth/issues/10))

### Fixed

* Fix standard compliance for confidential clients when requesting tokens
  ([#38](https://veenj.de/git/veenj/tiny-auth/issues/38))

* Fix wrong URLs in discovery endpoint
  ([#39](https://veenj.de/git/veenj/tiny-auth/issues/39))
...
* Offer refresh tokens
  ([#17](https://veenj.de/git/veenj/tiny-auth/issues/17))

* Remember authenticated users
  ([#3](https://veenj.de/git/veenj/tiny-auth/issues/3))

* Support password grants
  ([#9](https://veenj.de/git/veenj/tiny-auth/issues/9))

* Nice UI for login forms
  ([#2](https://veenj.de/git/veenj/tiny-auth/issues/2))

* [Documentation](doc/README.md)
  ([#25](https://veenj.de/git/veenj/tiny-auth/issues/25))

* OpenID Connect [Discovery
  endpoint](doc/endpoints.md#well-knownopenid-configuration)
  ([#24](https://veenj.de/git/veenj/tiny-auth/issues/24))
...
* Support encrypted passwords
  ([#23](https://veenj.de/git/veenj/tiny-auth/issues/23))

* Support client credentials authentication
  ([#8](https://veenj.de/git/veenj/tiny-auth/issues/8))

* Support configuration file store
  ([#4](https://veenj.de/git/veenj/tiny-auth/issues/4))

* Support for Implicit flow
  ([#7](https://veenj.de/git/veenj/tiny-auth/issues/7))

* Increase HTTP Security by disabling caching and adding CSRF countermeassures
  ([#14](https://veenj.de/git/veenj/tiny-auth/issues/14),
  [#1](https://veenj.de/git/veenj/tiny-auth/issues/1))

* TLS support
  ([#15](https://veenj.de/git/veenj/tiny-auth/issues/15))

* Issuance of access tokens
  ([#20](https://veenj.de/git/veenj/tiny-auth/issues/20))

* [Archlinux](https://www.archlinux.org/) package
  ([#13](https://veenj.de/git/veenj/tiny-auth/issues/13))

* Support for Authorization Code Flow
  ([#6](https://veenj.de/git/veenj/tiny-auth/issues/6))
