...
public class U2fTest extends TinyAuthBrowserTest {

    @Test
    @Disabled("Selenium U2F support is not documented")
    void testRegistration(Browser browser) {
        browser.startU2fRegistration()
                .register()
