...
public class ApiTests implements TinyAuthTest, ApiGadgets {
    ...
    void clientCredentialsWithDisallowedScopeIsFiltered() throws Exception {
        ...
        tokenAsserter().verifyToken(tokenResponse.getString(ID_TOKEN), client, client);
        tokenAsserter().verifyToken(tokenResponse.getString(ACCESS_TOKEN), client, client);
    }
    ...
    void testPasswordGrant() throws Exception {
        ...
        tokenAsserter().verifyToken(tokenResponse.getString(ID_TOKEN), client, user);
        tokenAsserter().verifyToken(tokenResponse.getString(ACCESS_TOKEN), client, user);
    }
