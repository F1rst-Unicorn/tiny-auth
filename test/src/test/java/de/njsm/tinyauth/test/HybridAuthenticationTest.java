...
public abstract class HybridAuthenticationTest extends TinyAuthBrowserTest {
    ...
    OidcToken verifyTokensFromAuthorizationCodeReturningRefreshToken(Set<String> scopes, String authCode) throws Exception {
        ...
        tokenAsserter().verifyAccessToken(tokenResponse.getString(ACCESS_TOKEN), client, user, getNonce());
        return tokenAsserter().verifyRefreshToken(tokenResponse.getString(REFRESH_TOKEN), client, user, getNonce(), scopes);
    }
    ...
    OidcToken verifyTokensFromResponse(Set<String> scopes, ValidatableResponse response) throws Exception {
        ...
        tokenAsserter().verifyRefreshToken(tokenResponse.getString(REFRESH_TOKEN), client, user, getNonce(), scopes);
        return tokenAsserter().verifyAccessToken(tokenResponse.getString(ACCESS_TOKEN), client, user, getNonce());
    }
    ...
    JsonPath fetchTokensAndVerifyBasics(Set<String> scopes, ValidatableResponse response) throws Exception {
        ...
        tokenAsserter().verifyAccessToken(tokenResponse.getString(ID_TOKEN), client, user, getNonce());
