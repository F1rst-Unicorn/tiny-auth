...
dependencies {
    ...
    testImplementation("org.apache.logging.log4j:log4j-api:2.25.4")
    testImplementation("org.apache.logging.log4j:log4j-core:2.25.4")
    testImplementation("org.apache.logging.log4j:log4j-web:2.25.4")
    testImplementation("org.apache.logging.log4j:log4j-slf4j2-impl:2.25.4")
    testImplementation("commons-io:commons-io:2.21.0")
    testImplementation("io.burt:jmespath-core:0.6.0")
    testImplementation("io.burt:jmespath-gson:0.6.0")
    ...
    testImplementation("org.testcontainers:nginx:1.21.4")
    testImplementation("org.testcontainers:selenium:1.21.4")
}
